...
public class MigrationReport {
    ...
    public MigrationReport(MigrationStatus status, String elementId, String type, String previousArtifactVersion,
            String newArtifactVersion, List<MigrationStepReport> migrationStepReport) {
        this.elementId = elementId;
        this.type = type;
        this.status = status.getValue();

    ...
    private void checkNotUsedByOther(Widget widget) {
        ...
        for (var repository : widgetContainerRepositories) {
            ...
            if (!componentsUsingWidget.isEmpty()) {
                ...
                message.append(" ").append(size).append(" ").append(repository.getComponentName())
                        .append(size > 1 ? "s" : "");
                componentsUsingWidget
                        .forEach(component -> message.append(", <").append(component.getName()).append(">"));

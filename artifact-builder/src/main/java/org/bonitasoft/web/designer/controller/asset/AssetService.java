...
public class AssetService<T extends Assetable> {
    ...
    public AssetService(Repository<T> repository, AssetRepository<T> assetRepository,
            AssetDependencyImporter<T> assetDependencyImporter) {
     ...
     */
    public void duplicateAsset(Path artifactSourcePath, Path artifactTargetPath, String sourceArtifactId,
        ...
        checkArgument(artifactSourcePath != null && exists(artifactSourcePath),
                format("source %s path is required", repository.getComponentName()));
        checkArgument(artifactTargetPath != null && exists(artifactTargetPath),
                format("target %s path is required", repository.getComponentName()));

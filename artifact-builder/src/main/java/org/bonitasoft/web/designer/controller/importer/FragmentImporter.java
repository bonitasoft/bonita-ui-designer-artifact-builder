...
public class FragmentImporter extends AbstractArtifactImporter<Fragment> {
    ...
    public FragmentImporter(JsonHandler jsonHandler, FragmentService fragmentService,
            FragmentRepository fragmentRepository, DependencyImporter... dependencyImporters) {

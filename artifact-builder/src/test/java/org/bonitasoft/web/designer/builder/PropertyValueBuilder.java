...
public class PropertyValueBuilder {
    ...
    public static PropertyValue anExpressionPropertyValue(Object value) {
        return new PropertyValueBuilder(new PropertyValue()).withType(ParameterType.EXPRESSION).withValue(value)
                .build();
    }

    public static PropertyValue aInterpolationPropertyValue(Object value) {
        return new PropertyValueBuilder(new PropertyValue()).withType(ParameterType.INTERPOLATION).withValue(value)
                .build();
    }

...
public class ImportReportBuilder {
    ...
    public ImportReport build() {
        ...
        for (Identifiable identifiable : added) {
            dependencies.addAddedDependency(identifiable.getClass().getSimpleName().toLowerCase(Locale.ENGLISH),
                    identifiable);
        }
        for (Identifiable identifiable : overwritten) {
            dependencies.addOverwrittenDependency(identifiable.getClass().getSimpleName().toLowerCase(Locale.ENGLISH),
                    identifiable);
        }

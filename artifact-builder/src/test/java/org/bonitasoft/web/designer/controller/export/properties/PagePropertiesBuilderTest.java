...
class PagePropertiesBuilderTest {
    ...
    void should_add_relative_bonita_resource_found_in_page_data() throws Exception {
        ...
        when(pageService.getResources(page)).thenReturn(Arrays.asList("GET|bpm/archivedUserTask", "GET|identity/user",
                "GET|bpm/userTask", "GET|identity/group"));

        String properties = new String(pagePropertiesBuilder.build(page));

        assertThat(properties).contains(
                "resources=[GET|bpm/archivedUserTask, GET|identity/user, GET|bpm/userTask, GET|identity/group]");
    }

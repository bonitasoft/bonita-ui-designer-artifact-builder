...
public class DirectiveFileGeneratorTest {
    ...
    public void should_list_all_widgets_except_container_used_in_page() throws Exception {
        ...
        assertThat(widgesFiles).containsOnly(temporaryFolder.toPath().resolve("pbLabel").resolve("pbLabel.js"),
                temporaryFolder.toPath().resolve("paragraph")
                        .resolve("paragraph.js"));
        assertThat(widgesFiles)
                .doesNotContain(temporaryFolder.toPath().resolve("pbContainer").resolve("pbContainer.js"));
    }

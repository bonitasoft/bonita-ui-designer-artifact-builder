...
public class JsonHandlerTest {
    ...
    public void should_serialize_object_into_json() throws Exception {
        ...
        JSONAssert.assertEquals(new String(jsonHandler.toJson(object)),
                "{\"name\":\"Vincent\",\"number\":1, \"another\": null, \"id\": \"id\"}", false);
    }
    ...
    public void should_deserialize_json_to_map() throws Exception {
        ...
        Assertions.assertThat(map.get("name")).isEqualTo("walter");
        Assertions.assertThat(map.get("lastname")).isEqualTo("bates");
    }
    ...
    public void should_serialize_map_into_json() throws Exception {
        ...
        JSONAssert.assertEquals(new String(jsonHandler.toJson(map)), "{\"name\":\"walter\",\"lastname\":\"bates\"}",
                false);
    }
    ...
    public void should_check_that_json_is_invalid() throws Exception {
        ...
        Assertions.assertThatThrownBy(() -> jsonHandler.checkValidJson(notjson.getBytes(StandardCharsets.UTF_8)))
    ...
    public void should_serialize_into_object_with_ignore_password() throws Exception {
        ...
        JSONAssert.assertEquals(expected, "{\"name\":\"Vincent\",\"number\":1, \"another\": null, \"id\": \"id\"}",
                false);
    }

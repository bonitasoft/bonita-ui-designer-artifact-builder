...
public abstract class AbstractPage extends DesignerArtifact
        implements Previewable, Identifiable, ElementContainer, Assetable {
    ...
    public boolean hasAsset(final AssetType type, final String name) {
        return assets.stream().anyMatch(asset -> AssetType.CSS.equals(type) && asset.getName().equals(name));
    }

 ...
 */
package org.bonitasoft.web.dao.model.data;
...
public class Variable {
    ...
    public Variable(@JsonProperty("type") DataType type, @JsonProperty("value") List<String> value,
            @JsonProperty("advancedOptions") VariableAdvancedOptions advancedOptions) {
        this.type = type;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("type", type).append("displayValue", displayValue)

...
@JsonPropertyOrder({ "id", "name", "displayName", "type", "uuid", "modelVersion", "previousArtifactVersion",
        "lastUpdate", "description", "rows", "variables", "assets", "inactiveAssets", "webResources" })

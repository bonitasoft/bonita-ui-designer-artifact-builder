 ...
 */
package org.bonitasoft.web.dao.model.fragment;
...
import org.bonitasoft.web.dao.model.JsonViewLight;
...
@JsonPropertyOrder({ "id", "name", "type", "modelVersion", "previousArtifactVersion", "lastUpdate", "description",
        "rows", "variables", "assets", "inactiveAssets", "webResources" })
